...
I decided to **build a portfolio of small bets** as recommended by [Daniel Vassallo](https://twitter.com/dvassallo). Hopefully, some of them will succeed, others will fail. Here's what I decided to focus my energies on for the next three months:

### Gems
It is a startup idea to pursue my vision of [extending (not replacing) human cognition with AI](https://gemsnotes.app/blog/augmented-cognition). With this global online migration comes new opportunities but also new challenges. There is a 24/7 [battle for our attention](https://gemsnotes.app/blog/attention-economy) and an overproduction of content. The ability to filter out the noise and process only what really matters is critical to saving time and mental energies. I have played around with this idea for a while, but now my goal is to achieve Problem/Solution Fit by the end of July. That is, finding 30 potential customers according to my current [traction roadmap](https://www.notion.so/Traction-roadmap-78246e6afe6b4880aafdd797c989d929).
...
[Here](https://www.notion.so/90-day-startup-68959c7a8d434f5f9ed94420ad2e297d) you can find my public notes from the course. I'll also share periodic updates on [Twitter](https://twitter.com/Ittaboba), [LinkedIn](https://www.linkedin.com/in/lorenzo-bernaschina-669a08b9/), and this same blog. At the end of the three months, I will review risks and outcomes to decide whether to pivot, persevere, or pause.
