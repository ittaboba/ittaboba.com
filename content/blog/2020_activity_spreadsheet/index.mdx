...
<ul>
    ...
    <li>
        <span style={{color: "rgb(246, 218, 16)", fontWeight: "bold"}}>Side projects</span> (building this blog, building <a href="/article/gems" active="_blank">Gems</a>, writing articles...)
    </li>
    <li>
